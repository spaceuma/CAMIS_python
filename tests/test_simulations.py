...
cl1Roots = [0.0, 0.20, 1.0]
cl2Roots = [0.0, 0.20, 1.0]
r2 = camis.CamisModel.fromRoots(cdRoots,caRoots,cl1Roots,cl2Roots, 45.0)
...
r3 = camis.CamisModel.fromRoots(cdRoots,caRoots,cl1Roots,cl2Roots, 45.0)
...
r4 = camis.CamisModel.fromRoots(cdRoots,caRoots,cl1Roots,cl2Roots, 45.0)
